            ...
            <div className="footer-body" data-scroll>
                ...
                <ul className="line-item footer-right cursor_hover">
                    <IconContext.Provider value={{ size: "2em", className: "social-icons" }}>
                        <li><a href="https://github.com/Kotlinski95/" target="_blank" rel="nofollow noopener noreferrer" title="github" className="cursor_hover" onClick={() => {
                            handleTrackingEvent("Github", "Github clicked", { page: `${_store.getState().pageState.page}` });
                        }}><FaGithub /></a></li>
                        <li><a href="https://www.instagram.com/adriankotlinski/" target="_blank" rel="nofollow noopener noreferrer" title="instagram" className="cursor_hover" onClick={() => {
                            handleTrackingEvent("Instagram", "Instagram clicked", { page: `${_store.getState().pageState.page}` });
                        }}><FaInstagram /></a></li>
                        <li><a href="https://www.facebook.com/adrian.kotlinski.9/" target="_blank" rel="nofollow noopener noreferrer" title="facebook" className="cursor_hover" onClick={() => {
                            handleTrackingEvent("Facebook", "Facebook clicked", { page: `${_store.getState().pageState.page}` });
                        }}><FaFacebookSquare /></a></li>
                        <li><a href="https://www.linkedin.com/in/adriankotlinski/" target="_blank" rel="nofollow noopener noreferrer" title="linkedin" className="cursor_hover" onClick={() => {
